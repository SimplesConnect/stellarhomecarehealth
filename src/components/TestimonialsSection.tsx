  ...
  return <section id="testimonials" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {testimonials.map((testimonial, index) => <Card key={index} className="shadow-soft hover:shadow-medium transition-all duration-300 relative">
              <CardContent className="p-6">
                ...
                <div className="flex items-center mb-4 mt-4">
                  {[...Array(testimonial.rating)].map((_, starIndex) => <Star key={starIndex} className="h-4 w-4 text-yellow-400 fill-current" />)}
                </div>
